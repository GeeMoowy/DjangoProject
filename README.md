...
- Реализовано решение, которое проверяет, что редактирование и удаление продукта доступно только его владельца.
- Из шаблона убраны кнопки с ограничениями доступа.
